...
public class CygnusVersionDetailPreferenceController extends BasePreferenceController {
    ...
    private static final String TAG = "CygnusVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_CYGNUS_VERSION_PROP = "ro.cygnus.version";
    private static final String KEY_CYGNUS_RELEASETYPE_PROP = "ro.system.cygnus.releasetype";
	...
	String cygnusVer = SystemProperties.get(KEY_CYGNUS_VERSION_PROP);
	String cygnusReleasetype =  SystemProperties.get(KEY_CYGNUS_RELEASETYPE_PROP);
	if (!cygnusVer.isEmpty() && !cygnusReleasetype.isEmpty())
	    return cygnusVer + " | " + cygnusReleasetype;
	else
